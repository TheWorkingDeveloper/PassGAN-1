...
with open(os.path.join(args.output_dir, 'charmap.pickle'), 'wb', encoding='utf8', errors='ignore') as f:
    pickle.dump(charmap, f)

with open(os.path.join(args.output_dir, 'inv_charmap.pickle'), 'wb', encoding='utf8', errors='ignore') as f:
...
with tf.compat.v1.Session() as session:
    ...
    for iteration in range(args.iters):
        ...
        print('train disc cost' + str(_disc_cost))
        ...
        if iteration % 100 == 0 and iteration > 0:
            ...
            for i in range(4):
                ...
                print(lib.plot.plot('js{}'.format(i+1), lm.js_with(true_char_ngram_lms[i])))

            with open(os.path.join(args.output_dir, 'samples', 'samples_{}.txt').format(iteration), 'w', encoding='utf8', errors='ignore') as f:
                for s in samples:
                    s = "".join(s)
                    f.write(s + "\n")
